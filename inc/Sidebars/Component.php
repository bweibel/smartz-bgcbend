...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function filter_body_classes( array $classes ) : array {
		if ( $this->is_primary_sidebar_active() ) {
			...
			if ( ! in_array( basename( $template ), [ 'front-page.php', '404.php', '500.php', 'offline.php', 'page.php', 'page-donate.php', 'page-family_plus.php', 'team_page.php', 'single-team_member.php', 'single-programs.php' ] ) ) {
				$classes[] = 'has-sidebar';
			}
		}
